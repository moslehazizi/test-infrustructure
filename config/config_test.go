...
func TestLoadConfig(t *testing.T) {
	...
	t.Run("success fetch postgres config", func(t *testing.T) {
		...
		os.Setenv("POSTGRES_MAX_OPEN_CONNECTION", strconv.Itoa(expectedPostgresMaxOpenConnection))
		...
		assert.Equal(t, cfg.Postgres.MaxOpenConnection, expectedPostgresMaxOpenConnection)
