...
type TestScenarioRepository interface {
	...
	UpdateScenarioAndConfig(ctx context.Context, scenario *entity.TestScenario) (e error)
	CreateScenarioAndConfig(ctx context.Context, scenario *entity.TestScenario) (e error)
}
