...
func Test_scenarioExecutor_Run(t *testing.T) {
	...
	t.Run("1_step_no_dynamic_agents_no_factorial_increment_failed_get_scenario_by_id", func(t *testing.T) {
		...
		agent1.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent2.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent3.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		...
		agent1.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent2.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent3.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent1.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent2.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent3.AssertNumberOfCalls(t, "DeleteTesting", 1)
	...
	t.Run("1_step_no_dynamic_agents_no_factorial_increment_failed_deprovision", func(t *testing.T) {
		...
		agent1.On("DeleteTesting", mock.Anything).Times(1).Return(errors.New("something went wrong"))
		agent2.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent3.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
	...
	t.Run("1_step_6_dynamic_agents_no_factorial_increment", func(t *testing.T) {
		...
		agent2.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent3.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent4.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent5.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent6.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent7.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent8.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		agent9.On("DeleteTesting", mock.Anything).Times(1).Return(nil)
		...
		agent2.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent3.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent4.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent5.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent6.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent7.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent8.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent9.AssertCalled(t, "DeleteTesting", mock.Anything)
		agent1.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent2.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent3.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent4.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent5.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent6.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent7.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent8.AssertNumberOfCalls(t, "DeleteTesting", 1)
		agent9.AssertNumberOfCalls(t, "DeleteTesting", 1)
